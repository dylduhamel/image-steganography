...
int main(int argc, char *argv[])
{
    ...
    argsOk = processHideImageArgs(argc, argv, &bit, textFilename, orgImageFilename); /* text file name is message text*/
    if(!argsOk) 
        return 1;
...
/*  function to hide the message in -b 1, 2, 4
    takes Image struct, bit specyfier, and the name of file where message is stores
